...
<body class="bg-main">
	<div class="container">
		<div class="box">
			...
			<form id="login-dorm" action="${cpath}/user/login" method="POST" autocomplete="off" style="width:100%;">
				<!-- 아이디/비밀번호 입력창 -->
				<input type="text" 
					id="user_name" name="user_name" class="input"
					required placeholder="아이디" />
				<input type="password" 
					id="user_password" name="user_password" class="input"
